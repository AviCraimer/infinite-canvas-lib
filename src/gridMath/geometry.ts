...
import { divCeil, divFloor, intSquareRoot } from "./arithmatic";
 ...
 */
export function intFracDistance(
  a: BlockAddress,
  b: BlockAddress,
...
export function linearInterpolation(
  ...
  const div = divFn === "floor" ? divFloor : divCeil;
  return a + div((b - a) * numer, denom);
}
